...
#     logging.info(f"property_id: {project_id}")
#     process(project_id)
...
#     url = f"https://www.99acres.com/4-bhk-bedroom-independent-house-villa-for-sale-in-heritage-villa-76-kasindra-ahmedabad-south-3798-sq-ft-npspid-{property_id}"
...
def wrapped_process(project_id):
    ...
    with counter_lock:
        ...
        # Check if we hit the limit of 30
